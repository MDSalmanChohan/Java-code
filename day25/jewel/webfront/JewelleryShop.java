...
public class JewelleryShop {
    ...
    private static void printASMAN() {
        ...
        System.out.println(" press 1 for .... rate Set for metal .");
        System.out.println(" press 2 for ... Search Jewel by metal .");
        System.out.println(" press 3 for .. Search Jewel by type ..");
        System.out.println(" press 4 for ... tell me price for Jewel  .");
        System.out.println(" press 5 for exit ... Thanks for visiting my shop ");
    }
